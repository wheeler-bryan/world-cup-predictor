...
export function ChampionDisplay( { champion } : {
    ...
    return (
        <div>
            {(champion) ?
                <div className="flex flex-col justify-center items-center rounded-2xl bg-gray-300 m-[1rem] md:m-[3rem] pb-[2rem]">
                    ...
                    <div className="flex justify-center pt-[1rem]">
                        <img src={"trophy.png"} alt={"trophy1"} height="150rem" width="140rem" />
                        <img src={champion.flag} alt={champion.abbreviation} height="200rem" width="150rem" />
                        <img src={"trophy.png"} alt={"trophy2"} height="150rem" width="140rem" />
                    </div>
                </div> : null}
        </div>
    );
