...
const advancingThird: Country[] = [
    groupB[3], groupE[1], groupF[3], groupD[1], groupI[1], groupL[3], fakeCountry, fakeCountry
]

const eliminated = [groupStageResults.map(c => c[3]), [groupH[1], groupC[2], fakeCountry, fakeCountry]].flat();
