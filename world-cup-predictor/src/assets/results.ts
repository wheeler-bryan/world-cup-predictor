...
export const winners_round_of_16: Country[] = [
    groupC[1], groupI[0], groupI[2], groupL[0], groupH[0], groupG[0], fakeCountry, fakeCountry
]
export const losers_round_of_16: Country[] = [
    groupB[0], groupD[1], groupC[0], groupA[0], groupK[0], groupD[0], fakeCountry, fakeCountry
]
