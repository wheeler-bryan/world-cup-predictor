...
const winners_round_of_32: Country[] = [
    groupB[0], groupC[0], groupD[1], groupC[1], fakeCountry, fakeCountry, fakeCountry, fakeCountry, fakeCountry, fakeCountry, fakeCountry, fakeCountry, fakeCountry, fakeCountry, fakeCountry, fakeCountry
]

const losers_round_of_32: Country[] = [
    groupA[2], groupF[1], groupE[0], groupF[0], fakeCountry, fakeCountry, fakeCountry, fakeCountry, fakeCountry, fakeCountry, fakeCountry, fakeCountry, fakeCountry, fakeCountry, fakeCountry, fakeCountry
]
